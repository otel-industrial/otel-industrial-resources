...
| [industrialscraper](https://github.com/otel-industrial/otel-industrial-resources/tree/main/otel-industrial-collector/industrialscraper) | Shared Go helper module for industrial receivers, extending scraperhelper: resilient connections, poll-concurrency limiting, byte-order decoding, block batching, and shared resource attributes. Developed in this org. Early: public API not yet stable, and resource-attribute names are provisional pending #11. | 🟡 Experimental       | [Dylan-M](https://github.com/Dylan-M) |
